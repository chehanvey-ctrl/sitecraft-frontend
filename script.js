<script>
  document.getElementById("generateBtn").addEventListener("click", async () => {
    ...
    try {
      ...
      if (!data.site_url) throw new Error("Live site URL not received.");
      ...
      outputDiv.innerHTML = "✅ Your AI site is ready! Redirecting to your live version...";

      // Redirect to success page with deployed site
      setTimeout(() => {
        window.location.href = `success.html?url=${encodeURIComponent(data.site_url)}`;
      }, 1500);
